...
export const useWeather = (locationName: string, unit: string, useMockData: boolean) => {
  ...
  const [hourlyWeather, setHourlyWeather] = useState<HourlyWeatherModel>(EmptyHourlyWeatherModel)
  const [dailyWeather, setDailyWeather] = useState<DailyWeatherModel>(EmptyDailyWeatherModel)
